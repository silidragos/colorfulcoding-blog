...
const HomePage = () => {
  ...
  useEffect(() => {
    fetch('/practimentor-hero-animation.json')
        ...
        <div className='my-20'>
          ...
          <div className='grid grid-cols-4 gap-10 mt-10'>
            <motion.div whileHover={{ scale: 1.05 }}>
              <img src="/article-images/collage-trainings.png" className='w-full' alt="Medical Universities" />
              <p>Medical Universities</p>
            </motion.div>
            <motion.div whileHover={{ scale: 1.05 }}>
              <img src="/article-images/collage-scans.png" className='w-full' alt="Industry Training" />
              <p>Industry Training</p>
            </motion.div>
            <motion.div whileHover={{ scale: 1.05 }}>
              <img src="/article-images/collage-stands-xr.png" className='w-full' alt="Vocational Schools" />
              <p>Vocational Schools</p>
            </motion.div>
            <motion.div whileHover={{ scale: 1.05 }}>
              <img src="/article-images/collage-arts-1.png" className='w-full' alt="Trainers & Coaches" />
