            ...
            <AwesomeSlider onTransitionEnd={e => {
                ...
                <div className="slider__video-card">
                    ...
                    <div className="absolute bottom-0 py-5 bg-lime-700/80 w-full">
                        ...
                        <p className="text-left text-xs w-11/12 m-auto font-light pt-5 pb-5"><b>(2023) - developement. </b> The motto that Oradea lives by today, art nouveau life nouveau, is written in centuries of history, with various social, religious and cultural influences. Come and discover together, to see with your own eyes what Piata Unirii once looked like!</p>
                        {/* <p className="w-full text-center underline pt-3"><a className="font-normal" target="_blank" href="https://artlink.app/">Find out more</a></p> */}
                    </div>
                </div>
                ...
                <div className="slider__video-card">
                    ...
                    <div className="absolute bottom-0 py-5 bg-purple-900/80 w-full">
                        ...
                        <p className="w-full text-center underline pt-3"><a className="font-normal" target="_blank" href="https://psyche60s.sigmaways.com/">Landing Page</a></p>
                    </div>
                </div>
                ...
                <div className="slider__video-card">
                    ...
                    <div className="absolute bottom-0 py-5 bg-blue-400/80 w-full">
                        ...
                        <p className="text-left text-xs w-11/12 m-auto font-light pt-5"><b>(2023)</b> With interactive games and delightful animations, every page turn is a step towards fun-filled learning. Make bedtime stories a magical journey towards a healthier tomorrow. Experience the magic, one interactive page at a time! </p>
                        <p className="w-full text-center underline pt-3"><a className="font-normal" target="_blank" href="https://copilcreativ.ro/">Landing Page</a></p>
                    </div>
                </div>
                ...
                <div className="slider__video-card">
                    ...
                    <div className="absolute bottom-0 py-5 bg-amber-800/80 w-full">
                        ...
                        <p className="w-full text-center underline pt-3"><a className="font-normal" target="_blank" href="https://www.youtube.com/watch?v=aAxUPClBPKk&ab_channel=HakawatiStudio">Teaser</a></p>
                    </div>
                </div>
