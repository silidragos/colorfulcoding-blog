...
let cardInfo = [
    ...
    {
        title: <>Arts &<br/> <span className="text-orange-500">Immersive Experiences</span></>,
    ...
    {
        title: <>Tourism & <br/><span className="text-orange-500">Cultural Storytelling</span></>,
    ...
    {
        title: <>Trainings &<br/> <span className="text-orange-500">Simulations</span></>,
