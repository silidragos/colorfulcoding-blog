    ...
    return (<nav className='fixed z-10' style={{ width: "100%" }}>
        ...
        {isBurgerMenuOpen && <div className='bg-orange-500 w-full h-screen'>
            <div className='w-full flex flex-wrap items-center justify-between mx-auto p-4'>
                ...
                <button onClick={() => setIsBurgerMenuOpen(false)}><Image src="/icons/exit.svg" alt="Burger Menu" width={40} height={40} /></button>
            </div>
            <div className='flex w-full m-auto text-zinc-900 text-5xl font-bold text-center h-screen' style={{ marginTop: "-150px" }}>
                ...
                <div className='absolute center w-full text-3xl underline' style={{ bottom: "100px" }}><a href="/#contact" onClick={() => setIsBurgerMenuOpen(false)}>Contact Us</a></div>
            </div>
        </div>
        }
    </nav >);
